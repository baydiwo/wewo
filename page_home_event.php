...
<div id="main-content" class="home-plus-events home-search">
		...
		<div class="container">
			<div class="row">
				...
				<?php endif; ?>
					...
					<?php get_template_part( 'block-home/block', 'recent-post-nonvideo' ); ?>
				...
				<?php if( !of_get_option( 'tokopress_home_recent_post_disable' ) ) : ?>
					...
					<div class="col-md-4 col-md-pull-8">
						<?php get_template_part( 'block-home/block', 'home-ad350-sidebar' ); ?>
					</div>
					<div class="col-md-4 col-md-pull-8">
	...
	<?php get_template_part( 'block-home/block', 'home-ad970-bottom' ); ?>
