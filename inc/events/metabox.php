...
add_action( 'add_meta_boxes', 'tokopress_metabox_event_details_add', 5 );
		...
		<tr>
			...
			<td>
				...
				<span class="description">
					<?php _e( 'This option will be <b>IGNORED</b> if you have active ticket for this event using Event Tickets or Event Tickets plugin.', 'tokopress' ); ?>
				</span>
			</td>
	    </tr>
